...
var f_s_sql_type = function(o_model_property){
    ...
    if(
        ...
        var n_maximum_string_length = o_model_property?.o_model_property_validation?.n_maximum_string_length;
        if(n_maximum_string_length){
            if(n_maximum_string_length <= 255){
                s_mysql_type = `TINYTEXT`
            }
        }
    }
