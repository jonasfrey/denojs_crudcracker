import { o_s_class_name_o_class } from "../models/classes/a_o_class.module.js";
...
var o_user__hans = new o_s_class_name_o_class.O_user(
    1,
    'hans',
    ...a_timestamps
);
...
var o_message__vonalice = new o_s_class_name_o_class.O_message(
    1,
    'hallo hans, wie gehts?', 
    ...a_timestamps
);
var o_message__vonhans = new o_s_class_name_o_class.O_message(
    2,
    'super und dir?', 
    ...a_timestamps
);
var o_chatroom__hansundalice = new o_s_class_name_o_class.O_chatroom(
    1, 
    'hans und alices chatraum', 
    ...a_timestamps
)
var o_user_o_message_o_chatroom_1 = new o_s_class_name_o_class.O_user_o_message_o_chatroom(
    1, 
    o_user__hans.n_id, 
...
var o_user_o_message_o_chatroom_2 = new o_s_class_name_o_class.O_user_o_message_o_chatroom(
    2, 
    o_user__alice.n_id, 
...
var a_o__testdata = [
    ...
    o_user_o_message_o_chatroom_1,
    o_user_o_message_o_chatroom_2
];
